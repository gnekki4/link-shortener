...
public interface LinkInfoMapper {
    ...
    LinkInfo linkInfoFromCreateLinkInfoRequest(CreateLinkInfoRequest request, String shortLink);

    LinkInfoResponse linkInfoResponseFromLinkInfo(LinkInfo linkInfo);
}
