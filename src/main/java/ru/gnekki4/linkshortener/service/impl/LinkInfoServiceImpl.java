...
public class LinkInfoServiceImpl implements LinkInfoService {
    ...
    public LinkInfoResponse createLinkInfo(CreateLinkInfoRequest createLinkInfoRequest) {
        ...
        var linkInfo = linkInfoMapper.linkInfoFromCreateLinkInfoRequest(createLinkInfoRequest, shortLink); // упс

        return linkInfoMapper.linkInfoResponseFromLinkInfo(linkInfoRepository.save(linkInfo));
    }
    ...
    public LinkInfoResponse getByShortLink(String shortLink) {
        return linkInfoRepository.findActiveByShortLink(shortLink, LocalDateTime.now())
                .map(linkInfoMapper::linkInfoResponseFromLinkInfo)
